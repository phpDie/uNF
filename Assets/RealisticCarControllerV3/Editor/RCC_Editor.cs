...
public class RCC_Editor : Editor {
	...
	public override void OnInspectorGUI () {
		...
		if(SteerSettings){
			...
			EditorGUILayout.Space();
			EditorGUILayout.PropertyField(serializedObject.FindProperty("currentSteerAngle"), new GUIContent("Maximum Steer Angle", "Maximum steer angle for your vehicle."), false);
